...
// ConnectConfig contains connection parameters for vCenter Server.
...
// RestClient manages RESTful interactions with vCenter, handling client
// initialization and credential storage.
