...
// ChooseSimulatorPreCreatedDatastore is a shortcut to choose any pre created Datastore.
...
// ChooseSimulatorPreCreatedHost is a shortcut to choose any pre created Host.
...
// ChooseSimulatorPreCreatedCluster is a shortcut to choose any pre created Cluster.
func (s *VCenterSimulator) ChooseSimulatorPreCreatedCluster() (*Cluster, *simulator.ClusterComputeResource) {
	h := simulator.Map.Any("ClusterComputeResource").(*simulator.ClusterComputeResource)
	ref := h.Reference()
	host := s.driver.NewCluster(&ref)
	return host, h
}
