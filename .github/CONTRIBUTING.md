...
# Develop a patch.
git push https://github.com/myuser/packer-plugin-vsphere f-my-feature
```
...
1. Navigate to the code:
   ...
   `cd $GOPATH/src/github.com/hashicorp/packer-plugin-vsphere`
...
2. Add the remote by running:
   ...
   `git remote add myuser https://github.com/myuser/packer-plugin-vsphere.git`
