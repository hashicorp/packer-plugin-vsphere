...
source "vsphere-iso" "autogenerated_1" {
  ...
  boot_command         = ["root<enter><wait>", "mount -t vfat /dev/fd0 /media/floppy<enter><wait>", "setup-alpine -f /media/floppy/answerfile<enter>", "<wait5>", "VMw@re1!<enter>", "VMw@re1!<enter>", "<wait5>", "y<enter>", "<wait10><wait10><wait10><wait10><wait10><wait10>", "reboot<enter>", "<wait10><wait10>", "root<enter>", "VMw@re1!<enter><wait>", "mount -t vfat /dev/fd0 /media/floppy<enter><wait>", "/media/floppy/SETUP.SH<enter>"]
  boot_wait            = "15s"
  ...
  iso_paths            = ["[datastore1] ISO/alpine-standard-3.20.3-x86_64.iso"]
  network_adapters {
    network_card = "vmxnet3"
    network      = "example-workload"
  }
  password     = "VMw@re1!"
